...
export default function WeatherWidget() {
  ...
  return (
    <div className=" bg-text bg-red-700 flex justify-center items-center h-screen  " >
      
      {/* Center the card within the screen */}
      <Card className="p-6  rounded-t-lg rounded-b-none shadow-md bg-slate-600 w-full max-w-md mx-auto text-center text-bold">
        {/* Card header with title and description */}
        <CardHeader >
          <CardTitle className="text-yellow-500 font-bold">World Weather Widget</CardTitle>
          <CardDescription className="text-pink-600 font-bold">
        ...
        <CardContent>
          ...
          <form onSubmit={handleSearch} className=" text-yellow-400 flex items-center gap-2">
            <Input
              type="text"
          ...
          {weather && (
            <div className=" bg-pink-500 mt-4 grid gap-2">
              {/* Display temperature message with icon */}
              <div className=" bg-green-600 flex items-center gap-2">
                <div className=" bg-yellow-500 flex items-center gap-2">
                  <ThermometerIcon className=" bg-blue-700 w-6 h-6" />
                  {getTemperatureMessage(weather.temperature, weather.unit)}
                </div>
              </div>
              {/* Display weather description message with icon */}
              <div className=" bg-pink-700 flex items-center gap-2">
                <CloudIcon className=" bg-blue-500 w-6 h-6 " />
                <div>{getWeatherMessage(weather.description)}</div>
              </div>
              {/* Display location message with icon */}
              <div className=" bg-slate-500 flex items-center gap-2">
                <MapPinIcon className=" bg-green-500 w-6 h-6 " />
